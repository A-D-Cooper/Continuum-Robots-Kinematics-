...
### Continuum robot are considered as 'n' circular arcs and useing these are its kinematics are modeled.
### We can use robot specific parameters and convert them to these circular parameters and then use those to map kinematics.
